import { Avatar, Box, CssBaseline, IconButton } from "@mui/material";
import BookMarkSvg from "../../../assets/svg/bookmark.svg";
import DiscussSvg from "../../../assets/svg/discuss.svg";
import { TopicsState } from "../../../state/api/fetchTopicsByCourseIdSlice";
let TopicsCard = (props: TopicsState) => {
  return (
    <>
      <CssBaseline />
      <Box
